<?php
	...
	$conn = db_connect();
	$result = getAllsuppliers($conn);
?>	
	<div>
	<a href="admin_signout.php" class="btn btn-danger"><span class="glyphicon glyphicon-off"></span>&nbsp;Logout</a>
	<a href="admin_medicine.php" class="btn btn-primary"><span class="glyphicon glyphicon-medicine"></span>&nbsp;Medicines</a>
    ...
    <?php
    if (isset($_SESSION['manager']) && $_SESSION['manager']==true){
		echo '<a class="btn btn-primary" href="admin_addsupplier.php"><span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;Add suplisher</a>';
	}        
    ?>
<?php
